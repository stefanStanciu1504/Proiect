...
\usepackage[hyphens]{url} % Useful for inserting web links nicely
...
\begin{figure}[!htbp]
	...
	\label{fig:zenbot}
\end{figure}
\footnotetext{\url{https://www.1000pipclimberea.com}}
\footnotetext[5]{\url{https://jaynagpaul.com/algorithmic-crypto-trading}}
\newpage
\section{Comparison}
...
\begin{figure}[!ht]
	...
	\label{fig:awt}
\end{figure}
\footnotetext{\url{https://www.javatpoint.com/java-awt}}
\newpage
...
\begin{figure}[!ht]
	...
	\label{fig:swing}
\end{figure}
\footnotetext{\url{https://www.javatpoint.com/java-swing}}
\newpage
...
\begin{figure}[!ht]
	\centering
	\subfloat[][\centering]{\includegraphics[width=16cm, height=4cm]{pics/profit1.png} }
	\qquad
	\subfloat[][\centering]{\includegraphics[width=16cm, height=2.5cm]{pics/profit2.png} }
	\caption{Profit made}
	\label{fig:profit}
\end{figure}
